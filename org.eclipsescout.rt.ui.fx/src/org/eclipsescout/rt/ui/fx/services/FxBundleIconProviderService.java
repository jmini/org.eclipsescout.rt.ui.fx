 ...
 ******************************************************************************/
package org.eclipsescout.rt.ui.fx.services;
...
/**
 * Implementation of an IconProviderService for this bundle.
 */
public class FxBundleIconProviderService extends IconProviderService {
  ...
  public FxBundleIconProviderService() {
  ...
  public IconSpec getIconSpec(String iconName) {
    // TODO: check (uses an extension point), throws a Nullpointerexception
    IconSpec iconSpec = null;//getContributedIconSpec(iconName);
    if (iconSpec == null) {
